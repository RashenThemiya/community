...
import {
    FaChartBar, FaClock, FaMoneyBillWave, FaStore, FaUsers,
} from "react-icons/fa";
...
const AdminDashboard = () => {
    ...
    const pendingCollection = (rentAmount - rentPaid) + (vatAmount - vatPaid) + (fineAmount - finePaid) + (opFeeAmount - opFeePaid);

    const invoiceData = [
        { name: "Paid", value: summary.invoiceCounts.paid_count, color: "#4CAF50" },
        { name: "Unpaid", value: summary.invoiceCounts.unpaid_count, color: "#F44336" },
        { name: "Partially Paid", value: summary.invoiceCounts.partial_count, color: "#2196F3" },
        { name: "Arrest", value: summary.invoiceCounts.arrest_count, color: "#FF9800" },
    ];
